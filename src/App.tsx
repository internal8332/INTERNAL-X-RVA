...
export default function App() {
  const [activeTab, setActiveTab] = useState<'mapper' | 'hexViewer' | 'bones'>('mapper');
  ...
  const loadBonesSandboxTemplate = () => {
    startBonesScanningProcess(SAMPLE_DUMP_CS, 'sandbox_dump.cs', SAMPLE_DUMP_CS.length, true);
  };
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center gap-4 justify-center">
                      ...
                      <button
                        onClick={loadBonesSandboxTemplate}
                        className="text-xs font-bold text-red-400/80 hover:text-red-400 transition-colors uppercase tracking-wider font-mono bg-red-950/10 hover:bg-red-950/25 border border-red-950/30 hover:border-red-500/25 px-4 py-2 rounded-xl cursor-pointer"
                      >
                        ⚡ Load Sandbox Demo Template
                      </button>
                    </div>
