...
const BONE_TARGETS: { name: string; search: string[]; stringName: string }[] = [
  { name: "Head", search: ["HNNLADDCHJH"], stringName: "HNNLADDCHJH" },
  { name: "Root", search: ["DBMKMFPNINN"], stringName: "DBMKMFPNINN" },
  { name: "LeftWrist", search: ["NAGPAOKADOG"], stringName: "NAGPAOKADOG" },
  { name: "Spine", search: ["LFNJAPOLEIH"], stringName: "LFNJAPOLEIH" },
  { name: "Hip", search: ["KHJBBPBIABM"], stringName: "KHJBBPBIABM" },
  { name: "RightCalf", search: ["HPDIEPFGLHA"], stringName: "HPDIEPFGLHA" },
  { name: "LeftCalf", search: ["JHEBHLMECMK"], stringName: "JHEBHLMECMK" },
  { name: "RightFoot", search: ["GIBLLJNFIEI"], stringName: "GIBLLJNFIEI" },
  { name: "LeftFoot", search: ["OBOIBCPFKJH"], stringName: "OBOIBCPFKJH" },
  { name: "RightWrist", search: ["ODFHOIJHBAJ"], stringName: "ODFHOIJHBAJ" },
  { name: "LeftHand", search: ["LHMNJHIDLKK"], stringName: "LHMNJHIDLKK" },
  { name: "LeftShoulder", search: ["PDPEOOOCJGL"], stringName: "PDPEOOOCJGL" },
  { name: "RightShoulder", search: ["LNLKGAHJFCG"], stringName: "LNLKGAHJFCG" },
  { name: "RightWristJoint", search: ["HJFCIGAEDAJ"], stringName: "HJFCIGAEDAJ" },
  { name: "LeftWristJoint", search: ["BFMNOMHECHG"], stringName: "BFMNOMHECHG" },
  { name: "LeftElbow", search: ["EEBJCDKOPOG"], stringName: "EEBJCDKOPOG" },
  { name: "RightElbow", search: ["ODIJOBGIAJM"], stringName: "ODIJOBGIAJM" },
  { name: "Collider", search: ["DCAPIGNAJOK"], stringName: "DCAPIGNAJOK" }
];

// Predefined OFFSETS targets organized by group
export interface OffsetTargetItem {
  name: string;
  group: 'Structural' | 'Player' | 'Silent Aim' | 'Speed' | 'Weapon';
  search: string[];
}

export const OFFSET_TARGETS: OffsetTargetItem[] = [
  // Structural
  { name: "StaticClass", group: "Structural", search: ["shb5"] },
  { name: "Weapon", group: "Structural", search: ["ActiveUISightingWeapon"] },
  { name: "WeaponData", group: "Structural", search: ["m_LastDisplayWeaponDataID"] },
  { name: "IntWeaponType", group: "Structural", search: ["weaponName"] },
  { name: "WeaponRecoil", group: "Structural", search: ["HINJKMBPDIL", "EFMCDHABKGP"] },
  { name: "NoReload", group: "Structural", search: ["ShootNoReload"] },
  { name: "FollowCamera", group: "Structural", search: ["OHEPMNHMJMK", "GAGEFHOJDLL"] },
  { name: "AimRotation", group: "Structural", search: ["MDCADLIAJIH"] },
  { name: "CurrentObserver", group: "Structural", search: ["m_CurrentObserverID"] },
  { name: "ObserverPlayer", group: "Structural", search: ["m_TargetPlayerID"] },
  { name: "LocalPlayerAttributes", group: "Structural", search: ["KDJHNBAECLM"] },
  { name: "CurrentMatch", group: "Structural", search: ["m_Match"] },
  { name: "MatchStatus", group: "Structural", search: ["m_State"] },
  { name: "LocalPlayer", group: "Structural", search: ["m_LocalPlayer"] },
  { name: "Camera", group: "Structural", search: ["m_FollowCamera"] },
  { name: "Player_Data", group: "Structural", search: ["HudPetSkillCDAnimEvt"] },
  { name: "Avatar", group: "Structural", search: ["m_AvatarTransformID"] },
  { name: "AvatarManager", group: "Structural", search: ["m_AvatarManager"] },
  { name: "Player_ShadowBase", group: "Structural", search: ["m_ShadowState"] },
  { name: "Avatar_Data", group: "Structural", search: ["avatarId"] },
  { name: "Avatar_Data_IsTeam", group: "Structural", search: ["isTeammate"] },
  { name: "Avatar_IsVisible", group: "Structural", search: ["m_IsVisible"] },
  { name: "IsFiring", group: "Structural", search: ["BPKPEBLBMAJ", "LPEIEILIKGC"] },
  { name: "DictionaryEntities", group: "Structural", search: ["m_ReplicationEntitis"] },

  // Player
  { name: "Player_IsDead", group: "Player", search: ["isDead"] },
  { name: "Player_Name", group: "Player", search: ["IBNEFAFFDMA", "OIAJCBLDHKP"] },
  { name: "XPose", group: "Player", search: ["m_TransformLocalPosition"] },
  { name: "AimbotVisible", group: "Player", search: ["DCAPIGNAJOK", "HECFNHJKOMN"] },
  { name: "PlayerAttributes", group: "Player", search: ["KDJHNBAECLM"] },
  { name: "MainCameraTransform", group: "Player", search: ["MainCameraTransform"] },
  { name: "ViewMatrix", group: "Player", search: ["SetViewMatrix"] },
  { name: "InSnowSlideWayDashing", group: "Player", search: ["InSnowSlideWayDashing"] },
  { name: "PlayerID", group: "Player", search: ["m_FollowPlayerID", "PlayerID"] },
  { name: "BaseProfileInfo", group: "Player", search: ["BaseProfileInfo"] },
  { name: "IsClientBot", group: "Player", search: ["IsClientBot"] },
  { name: "RunSpeedUpScale", group: "Player", search: ["RunSpeedUpScale"] },

  // Silent Aim
  { name: "pomba", group: "Silent Aim", search: ["BPKPEBLBMAJ", "LPEIEILIKGC"] },
  { name: "sAim2", group: "Silent Aim", search: ["AKFLHNOIHED", "GEGFCFDGGGP"] },
  { name: "sAim3", group: "Silent Aim", search: ["m_StartPosition"] },
  { name: "sAim4", group: "Silent Aim", search: ["m_Target"] },
  { name: "guntipposition", group: "Silent Aim", search: ["m_StartPosition"] },
  { name: "LastAimingInfoFromWeapon", group: "Silent Aim", search: ["LastAimingInfoFromWeaponAdjusted"] },

  // Speed
  { name: "GameTimer", group: "Speed", search: ["m_DeltaTime"] },
  { name: "FixedDeltaTime", group: "Speed", search: ["m_FixedDeltaTime"] },
  { name: "PlayerSpeed", group: "Speed", search: ["m_highSpeedSteerAngleBackup"] },

  // Weapon
  { name: "WeaponInfo", group: "Weapon", search: ["cs_peak_iconic_weapon_info"] },
  { name: "WeaponID", group: "Weapon", search: ["WeaponID"] },
  { name: "WeaponOnHand", group: "Weapon", search: ["WeaponOnHand"] },
  { name: "CombineWeaponOnHand", group: "Weapon", search: ["CombineWeaponOnHand"] }
];

const OFFSET_GROUPS = ['ALL', 'Structural', 'Player', 'Silent Aim', 'Speed', 'Weapon'] as const;
...
public class GameManager : MonoBehaviour
{
	...
	// RVA: 0x61A2B0 Offset: 0x61A2B0
	public void InSnowSlideWayDashing() { }

	// RVA: 0x992B10 Offset: 0x992B10
	public static void ShootNoReload() { }

	// RVA: 0x184C00 Offset: 0x184C00
...
public class WeaponManager : MonoBehaviour
{
	...
	protected int m_LastDisplayWeaponDataID; // 0x48
	protected string weaponName; // 0x50
	protected float HINJKMBPDIL; // 0x54
	protected int WeaponOnHand; // 0x60
	protected int CombineWeaponOnHand; // 0x68
	protected int WeaponID; // 0x70
	protected int cs_peak_iconic_weapon_info; // 0x78
	protected float m_DeltaTime; // 0x80
	protected float m_FixedDeltaTime; // 0x84
	protected float m_highSpeedSteerAngleBackup; // 0x88
}

public class PlayerBones : MonoBehaviour
{
	protected ITransformNode HNNLADDCHJH; // 0x458
	protected ITransformNode DBMKMFPNINN; // 0x460
	protected ITransformNode NAGPAOKADOG; // 0x468
	public static ITransformNode LFNJAPOLEIH; // 0x470
	private TransformNode KHJBBPBIABM; // 0x478
	protected ITransformNode HPDIEPFGLHA; // 0x480
	protected ITransformNode JHEBHLMECMK; // 0x488
	protected ITransformNode GIBLLJNFIEI; // 0x490
	protected ITransformNode OBOIBCPFKJH; // 0x498
	protected ITransformNode ODFHOIJHBAJ; // 0x4A0
	protected ITransformNode LHMNJHIDLKK; // 0x4A8
	protected ITransformNode PDPEOOOCJGL; // 0x4B0
	protected ITransformNode LNLKGAHJFCG; // 0x4B8
	protected ITransformNode HJFCIGAEDAJ; // 0x4C0
	protected ITransformNode BFMNOMHECHG; // 0x4C8
	protected ITransformNode EEBJCDKOPOG; // 0x4D0
	protected ITransformNode ODIJOBGIAJM; // 0x4D8
	protected ITransformNode DCAPIGNAJOK; // 0x4E0

	public int shb5; // 0x30
	public bool ActiveUISightingWeapon; // 0x34
	public Transform OHEPMNHMJMK; // 0x38
	public Vector3 MDCADLIAJIH; // 0x40
	public int m_CurrentObserverID; // 0x4C
	public int m_TargetPlayerID; // 0x50
	public int KDJHNBAECLM; // 0x58
	public int m_Match; // 0x60
	public int m_State; // 0x64
	public int m_LocalPlayer; // 0x68
	public Transform m_FollowCamera; // 0x70
	public int HudPetSkillCDAnimEvt; // 0x78
	public int m_AvatarTransformID; // 0x80
	public int m_AvatarManager; // 0x88
	public int m_ShadowState; // 0x90
	public int avatarId; // 0x94
	public bool isTeammate; // 0x98
	public bool m_IsVisible; // 0x99
	public bool BPKPEBLBMAJ; // 0x9A
	public int m_ReplicationEntitis; // 0xA0
	public bool isDead; // 0xA8
	public string IBNEFAFFDMA; // 0xB0
	public Vector3 m_TransformLocalPosition; // 0xB8
	public Transform MainCameraTransform; // 0xC8
	public int m_FollowPlayerID; // 0xD0
	public int BaseProfileInfo; // 0xD8
	public bool IsClientBot; // 0xDC
	public float RunSpeedUpScale; // 0xE0
	public Vector3 AKFLHNOIHED; // 0xE8
	public Vector3 m_StartPosition; // 0xF4
	public Vector3 m_Target; // 0x100
	public int LastAimingInfoFromWeaponAdjusted; // 0x10C
}
`;
...
export default function App() {
  const [activeTab, setActiveTab] = useState<'mapper' | 'hexViewer' | 'bones' | 'offsets' | 'direct' | 'aimbot'>('mapper');

  // OFFSETS FINDER States
  const [offsetsView, setOffsetsView] = useState<'upload' | 'scanning' | 'results'>('upload');
  const [offsetsFileContent, setOffsetsFileContent] = useState<string>('');
  const [offsetsFileName, setOffsetsFileName] = useState<string>('');
  const [offsetsFileSize, setOffsetsFileSize] = useState<number>(0);
  const [isOffsetsDragging, setIsOffsetsDragging] = useState<boolean>(false);
  const [isOffsetsScanning, setIsOffsetsScanning] = useState<boolean>(false);
  const [offsetsScanProgress, setOffsetsScanProgress] = useState<number>(0);
  const [offsetsResults, setOffsetsResults] = useState<{ name: string; group: string; matchedSearch: string; offset: string }[]>([]);
  const [offsetsScanTime, setOffsetsScanTime] = useState<number>(0);
  const [offsetsCopiedId, setOffsetsCopiedId] = useState<string | null>(null);
  const [offsetsCopiedAll, setOffsetsCopiedAll] = useState<boolean>(false);
  const [offsetsErrorMessage, setOffsetsErrorMessage] = useState<string>('');
  const [isOffsetsDemo, setIsOffsetsDemo] = useState<boolean>(false);
  const [offsetsFilterQuery, setOffsetsFilterQuery] = useState<string>('');
  const [offsetsSelectedGroup, setOffsetsSelectedGroup] = useState<string>('ALL');
  ...
  const executeBonesScan = useCallback((content: string): { results: { boneName: string; stringName: string; offset: string }[]; duration: number } => {
    ...
    BONE_TARGETS.forEach(({ name, search, stringName }) => {
      const searchTerms = search && search.length > 0 ? search : (stringName ? [stringName] : []);
      let foundOffset = '';
      let matchedString = '';

      for (const term of searchTerms) {
        const stringNameUpper = term.toUpperCase();
      ...
      if (foundOffset) {
        results.push({
          boneName: name,
          stringName: matchedString || searchTerms[0] || stringName,
          offset: foundOffset
        });
      }
    });
  ...
  // Offsets Finder Event Handlers and Helpers
  const offsetsFileInputRef = useRef<HTMLInputElement>(null);

  // Perform the offsets scanning across all 5 groups
  const executeOffsetsScan = useCallback((content: string): { results: { name: string; group: string; matchedSearch: string; offset: string }[]; duration: number } => {
    const startTime = performance.now();
    const results: { name: string; group: string; matchedSearch: string; offset: string }[] = [];
    const lines = content.split('\n');

    OFFSET_TARGETS.forEach(target => {
      let foundOffset = '';
      let matchedTerm = '';

      for (const term of target.search) {
        const termUpper = term.toUpperCase();

        for (let i = 0; i < lines.length; i++) {
          const line = lines[i];
          if (line.toUpperCase().includes(termUpper)) {
            // 1. Try finding offset on the current line (typical for fields: `protected int m_LastDisplayWeaponDataID; // 0x48`)
            const commentIndex = line.indexOf('//');
            if (commentIndex !== -1) {
              const commentText = line.substring(commentIndex + 2).trim();
              const hexMatch = commentText.match(/0x[0-9a-fA-F]+/i);
            ...
            // 2. If not found on current line, check preceding 1-5 lines (typical for methods: `// RVA: 0x... Offset: 0x...`)
            if (!foundOffset) {
              for (let j = Math.max(0, i - 5); j < i; j++) {
                const prevLine = lines[j];
                const rvaOffsetMatch = prevLine.match(/(?:Offset|RVA):\s*(0x[0-9a-fA-F]+)/i) || prevLine.match(/\/\/\s*(0x[0-9a-fA-F]+)/i);
                if (rvaOffsetMatch) {
                  foundOffset = rvaOffsetMatch[1];
                  break;
                }
              }
            }

            // 3. If still not found, check 1 line below
            if (!foundOffset && i + 1 < lines.length) {
              const nextLine = lines[i + 1];
              const nextMatch = nextLine.match(/\/\/\s*(0x[0-9a-fA-F]+)/i);
              if (nextMatch) {
                foundOffset = nextMatch[1];
              }
            }

            if (foundOffset) {
              matchedTerm = term;
              break; // Found offset for this target, stop searching lines
            }
          }
        }

        if (foundOffset) {
          break; // Stop searching remaining alternate signatures
        }
      }

      // ONLY SHOW ITEMS THAT ARE SUCCESSFULLY FOUND
      if (foundOffset) {
        results.push({
          name: target.name,
          group: target.group,
          matchedSearch: matchedTerm || target.search[0],
          offset: foundOffset
        });
      }
    });
  ...
  const startOffsetsScanningProcess = useCallback((content: string, name: string, size: number, isSample: boolean = false) => {
    setOffsetsFileContent(content);
    setOffsetsFileName(name);
    setOffsetsFileSize(size);
    setIsOffsetsDemo(isSample);
    setOffsetsErrorMessage('');

    setOffsetsView('scanning');
    setOffsetsScanProgress(0);
    setIsOffsetsScanning(true);
    ...
    const interval = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        const scan = executeOffsetsScan(content);

        setTimeout(() => {
          setOffsetsResults(scan.results);
          setOffsetsScanTime(scan.duration);
          setIsOffsetsScanning(false);
          setOffsetsView('results');
        }, 400);
      } else {
        setOffsetsScanProgress(progress);
      }
    }, 40);
  }, [executeOffsetsScan]);

  const handleOffsetsFile = (file: File) => {
    if (!file.name.endsWith('.cs') && !file.name.endsWith('.txt')) {
      setOffsetsErrorMessage('Please upload a valid Unity dump.cs or text file.');
      return;
    }
    ...
    reader.onload = (e) => {
      const text = e.target?.result as string;
      startOffsetsScanningProcess(text, file.name, file.size);
    };
    reader.onerror = () => {
      setOffsetsErrorMessage('Failed to read file. Please try again.');
    };
    reader.readAsText(file);
  };

  const handleOffsetsFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      handleOffsetsFile(e.target.files[0]);
    }
  };

  const handleOffsetsDragOver = (e: React.DragEvent) => {
    e.preventDefault();
    setIsOffsetsDragging(true);
  };

  const handleOffsetsDragLeave = () => {
    setIsOffsetsDragging(false);
  };

  const handleOffsetsDrop = (e: React.DragEvent) => {
    e.preventDefault();
    setIsOffsetsDragging(false);
    if (e.dataTransfer.files && e.dataTransfer.files.length > 0) {
      handleOffsetsFile(e.dataTransfer.files[0]);
    }
  };

  const triggerOffsetsFileBrowser = () => {
    offsetsFileInputRef.current?.click();
  };
    ...
    <div className="min-h-screen bg-[#08080c] text-slate-100 font-sans flex flex-col selection:bg-red-500/30 selection:text-red-200 select-none">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 flex flex-col justify-center">
        ...
        <AnimatePresence mode="wait">
          ...
          {/* VIEW: OFFSETS FINDER TAB */}
          {activeTab === 'offsets' && (
            <motion.div
              key="offsets-view-container"
              initial={{ opacity: 0, y: 15 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -15 }}
              transition={{ duration: 0.25, ease: 'easeOut' }}
            ...
            >
              {offsetsView === 'upload' && (
                ...
                >
                  <div 
                    onDragOver={handleOffsetsDragOver}
                    onDragLeave={handleOffsetsDragLeave}
                    onDrop={handleOffsetsDrop}
                    className={`bg-[#0d0d14]/90 backdrop-blur-xl border rounded-3xl p-8 text-center relative overflow-hidden transition-all duration-300 shadow-2xl ${
                      isOffsetsDragging 
                        ? 'border-red-500 bg-red-500/5 shadow-[0_0_40px_rgba(239,68,68,0.15)] scale-[1.01]' 
                        : 'border-red-950/30 hover:border-red-500/20'
                  ...
                  >
                    {/* Dragging state overlay */}
                    <div className={`absolute inset-0 bg-[#08080c]/90 z-20 flex flex-col items-center justify-center transition-opacity duration-300 pointer-events-none ${isOffsetsDragging ? 'opacity-100' : 'opacity-0'}`}>
                      <Upload className="w-14 h-14 text-red-500 mb-3 animate-bounce" />
                      <p className="text-base font-bold text-red-400 font-display">Drop your Dump.cs file here</p>
                      <p className="text-xs text-slate-500 mt-1">Release to start automatic offsets scan</p>
                    </div>
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-white mb-2 font-display">
                      Scan Unity <span className="text-red-500">Offsets</span> Database
                    </h2>
                    
                    <p className="text-sm text-slate-400 max-w-md mx-auto leading-relaxed mb-8">
                      Upload your Dump.cs file to automatically scan and extract memory offsets for Structural classes, Player attributes, Silent Aim vectors, Speed modifiers, and Weapon parameters.
                    </p>

                    {offsetsErrorMessage && (
                      <div className="mb-6 p-3 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 text-xs font-semibold flex items-center justify-center gap-2">
                        <X className="w-4 h-4 shrink-0 cursor-pointer" onClick={() => setOffsetsErrorMessage('')} />
                        <span>{offsetsErrorMessage}</span>
                      </div>
                    )}

                    <div className="flex flex-col sm:flex-row items-center gap-3 justify-center">
                      <button
                        onClick={triggerOffsetsFileBrowser}
                        className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-bold font-display text-xs rounded-xl shadow-[0_0_20px_rgba(239,68,68,0.3)] hover:shadow-[0_0_25px_rgba(239,68,68,0.45)] hover:scale-[1.02] transition-all cursor-pointer uppercase tracking-wider flex items-center justify-center gap-2"
                      >
                        <Upload className="w-4 h-4" />
                        <span>SELECT DUMP.CS FILE</span>
                      </button>
                    </div>

                    <input 
                      type="file" 
                      ref={offsetsFileInputRef} 
                      onChange={handleOffsetsFileChange} 
                      accept=".cs,.txt" 
                      className="hidden" 
                    />

                    <div className="mt-8 pt-6 border-t border-red-950/20 flex flex-wrap items-center justify-center gap-6 text-[11px] text-slate-500 font-mono uppercase">
                      <span className="flex items-center gap-1.5">
                        <CheckCircle2 className="w-3.5 h-3.5 text-red-500/60" /> 49 SIGNATURE TARGETS
                      </span>
                      <span className="flex items-center gap-1.5">
                        <CheckCircle2 className="w-3.5 h-3.5 text-red-500/60" /> 5 CORE GROUPS
                      </span>
                      <span className="flex items-center gap-1.5">
                        <CheckCircle2 className="w-3.5 h-3.5 text-red-500/60" /> 100% OFFLINE SECURE
                      </span>
              ...
              {offsetsView === 'scanning' && (
                <motion.div
                  key="offsets-scanning-view"
                  initial={{ opacity: 0, scale: 0.98 }}
                  animate={{ opacity: 1, scale: 1 }}
                  exit={{ opacity: 0 }}
                  transition={{ duration: 0.2 }}
                ...
                >
                  <div className="bg-[#0d0d14]/90 backdrop-blur-xl border border-red-500/10 rounded-3xl p-10 shadow-2xl relative">
                    ...
                    <div className="relative w-20 h-20 mx-auto mb-8">
                      ...
                      <div className="absolute inset-0 rounded-full border-4 border-t-red-500 border-r-red-500/40 animate-spin"></div>
                      <div className="absolute inset-2 bg-[#08080c] rounded-full flex items-center justify-center">
                        <Layers className="w-7 h-7 text-red-500 animate-pulse" />
                      </div>
                    </div>
                    ...
                    <p className="text-sm text-slate-400 font-medium mb-6 animate-pulse">
                      Parsing Structural, Player, Aim, Speed & Weapon signatures...
                    </p>
                    ...
                    <div className="space-y-2 max-w-xs mx-auto">
                      <div className="w-full bg-red-950/20 h-2 rounded-full overflow-hidden border border-red-500/10 p-[1px]">
                        <div 
                          className="bg-gradient-to-r from-red-600 to-red-500 h-full rounded-full transition-all duration-150 shadow-[0_0_10px_#EF4444]"
                          style={{ width: `${offsetsScanProgress}%` }}
                        ></div>
                      </div>
                      <div className="flex justify-between items-center text-[10px] font-mono text-slate-500 uppercase tracking-widest font-bold">
                        <span>STATUS: EXTRACTING</span>
                        <span className="text-red-400 font-bold">{offsetsScanProgress}%</span>
                      </div>
                    </div>
                ...
                >
                  ...
                  <div className="bg-[#0d0d14]/80 backdrop-blur-md border border-red-950/30 rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
                    <div className="flex items-center gap-3 w-full md:w-auto">
                      ...
                      <div className="truncate">
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-bold text-white font-mono truncate max-w-[200px] sm:max-w-xs">{offsetsFileName}</span>
                          {isOffsetsDemo && (
                            <span className="text-[9px] bg-red-500/10 text-red-400 border border-red-500/25 px-2 py-0.5 rounded font-mono uppercase font-bold tracking-widest">SANDBOX</span>
                          )}
                        </div>
                        <div className="flex items-center gap-2 mt-0.5">
                          <span className="text-[10px] text-slate-500 font-mono font-medium">SIZE: {(offsetsFileSize / 1024).toFixed(1)} KB</span>
                          <span className="text-slate-700 font-mono">•</span>
                          <span className="text-[10px] text-red-400 font-mono font-bold">{offsetsResults.length} OFFSETS FOUND</span>
                          <span className="text-slate-700 font-mono">•</span>
                          <span className="text-[10px] text-slate-500 font-mono font-medium">{offsetsScanTime}ms</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                      ...
                      <button
                        onClick={() => {
                          const grouped: Record<string, typeof offsetsResults> = {};
                          offsetsResults.forEach(r => {
                            if (!grouped[r.group]) grouped[r.group] = [];
                            grouped[r.group].push(r);
                          });

                          let text = `// Auto-Extracted Offsets (${offsetsResults.length} Items Found)\n\n`;
                          for (const [grp, items] of Object.entries(grouped)) {
                            text += `// ================= ${grp.toUpperCase()} =================\n`;
                            items.forEach(it => {
                              text += `${it.name.padEnd(28)} = ${it.offset};\n`;
                            });
                            text += '\n';
                          }

                          navigator.clipboard.writeText(text);
                          setOffsetsCopiedAll(true);
                          setTimeout(() => setOffsetsCopiedAll(false), 1500);
                        }}
                        disabled={offsetsResults.length === 0}
                        className="px-4 py-2.5 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-bold font-display text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5 uppercase disabled:opacity-40 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(239,68,68,0.2)]"
                      >
                        {offsetsCopiedAll ? (
                          <>
                          ...
                          <>
                            <Copy className="w-4 h-4" />
                            <span>COPY ALL ({offsetsResults.length})</span>
                          </>
                        )}
                      </button>
                      ...
                      <button
                        onClick={() => {
                          setOffsetsView('upload');
                          setOffsetsResults([]);
                          setOffsetsFileContent('');
                          setOffsetsFileName('');
                          setOffsetsFileSize(0);
                          setOffsetsFilterQuery('');
                          setOffsetsSelectedGroup('ALL');
                        }}
                        className="px-4 py-2.5 bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-red-500/30 text-slate-300 hover:text-white font-bold font-display text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5 uppercase"
                      >
                        <ArrowLeft className="w-4 h-4" />
                  ...
                  {/* Filter & Search Strip */}
                  <div className="bg-[#0d0d14]/90 backdrop-blur-xl border border-red-950/30 rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
                    {/* Group Filter Tabs */}
                    <div className="flex items-center gap-1.5 overflow-x-auto w-full md:w-auto pb-1 md:pb-0 scrollbar-none">
                      {OFFSET_GROUPS.map((groupName) => {
                        const count = groupName === 'ALL' 
                          ? offsetsResults.length 
                          : offsetsResults.filter(r => r.group === groupName).length;
                        const isSelected = offsetsSelectedGroup === groupName;

                        return (
                          <button
                            key={groupName}
                            onClick={() => setOffsetsSelectedGroup(groupName)}
                            className={`px-3 py-1.5 rounded-lg text-xs font-bold font-display tracking-wider uppercase transition-all flex items-center gap-1.5 shrink-0 cursor-pointer ${
                              isSelected
                                ? 'bg-red-500/15 border border-red-500/40 text-red-400 shadow-[0_0_10px_rgba(239,68,68,0.1)]'
                                : 'bg-slate-900/60 border border-slate-800/60 text-slate-400 hover:text-slate-200 hover:border-slate-700'
                            }`}
                          >
                            <span>{groupName}</span>
                            <span className={`text-[10px] px-1.5 py-0.2 rounded font-mono font-bold ${
                              isSelected ? 'bg-red-500/20 text-red-300' : 'bg-slate-800 text-slate-500'
                            }`}>
                              {count}
                            </span>
                          </button>
                    ...
                    <div className="relative w-full md:w-72">
                      ...
                      <input
                        type="text"
                        value={offsetsFilterQuery}
                        onChange={(e) => setOffsetsFilterQuery(e.target.value)}
                        placeholder="Search offset name, search tag, or hex..."
                        className="w-full pl-9 pr-8 py-2 bg-[#060609] border border-red-950/30 focus:border-red-500/50 rounded-xl text-xs text-white placeholder:text-slate-600 focus:outline-none transition-all font-mono"
                      />
                      {offsetsFilterQuery && (
                        <button
                          onClick={() => setOffsetsFilterQuery('')}
                  ...
                  {/* Results Content */}
                  {offsetsResults.length === 0 ? (
                    <div className="bg-[#0d0d14]/95 backdrop-blur-xl border border-red-950/30 rounded-3xl p-16 text-center shadow-2xl">
                      <X className="w-12 h-12 text-slate-700 mx-auto mb-3 animate-pulse" />
                      <h4 className="font-bold text-base text-white font-display mb-1">NO TARGET OFFSETS FOUND</h4>
                      <p className="text-xs text-slate-500 max-w-sm mx-auto">None of the defined 49 offset signatures were found in the uploaded Dump.cs file.</p>
                    </div>
                  ) : (
                    <div className="space-y-6">
                      {/* Render by Groups */}
                      {(['Structural', 'Player', 'Silent Aim', 'Speed', 'Weapon'] as const).map(grp => {
                        if (offsetsSelectedGroup !== 'ALL' && offsetsSelectedGroup !== grp) {
                          return null;
                        }

                        const groupItems = offsetsResults.filter(r => {
                          if (r.group !== grp) return false;
                          if (!offsetsFilterQuery) return true;
                          const q = offsetsFilterQuery.toLowerCase();
                          return (
                            r.name.toLowerCase().includes(q) ||
                            r.offset.toLowerCase().includes(q) ||
                            r.matchedSearch.toLowerCase().includes(q)
                          );
                        });

                        if (groupItems.length === 0) {
                          if (offsetsSelectedGroup === grp) {
                            return (
                              <div key={grp} className="bg-[#0d0d14]/95 backdrop-blur-xl border border-red-950/30 rounded-3xl p-12 text-center shadow-2xl">
                                <Search className="w-10 h-10 text-slate-700 mx-auto mb-2" />
                                <h4 className="font-bold text-sm text-white font-display">No matching offsets in {grp}</h4>
                                <p className="text-xs text-slate-500 mt-1">Try clearing the search query.</p>
                              </div>
                            );
                          }
                          return null;
                        ...
                        return (
                          <div key={grp} className="bg-[#0d0d14]/95 backdrop-blur-xl border border-red-950/30 rounded-3xl overflow-hidden shadow-2xl">
                            {/* Group Header */}
                            <div className="p-4 sm:p-5 border-b border-red-950/25 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-red-950/[0.06]">
                              <div className="flex items-center gap-2.5">
                                <div className="w-2.5 h-2.5 rounded-full bg-red-500 shadow-[0_0_8px_#EF4444]" />
                                <h3 className="text-xs font-bold tracking-widest uppercase text-white font-display">
                                  {grp.toUpperCase()} GROUP
                                </h3>
                                <span className="text-[10px] bg-red-500/10 text-red-400 border border-red-500/20 px-2 py-0.5 rounded font-mono font-bold">
                                  {groupItems.length} FOUND
                                </span>
                              </div>

                              <button
                                onClick={() => {
                                  let text = `// ${grp.toUpperCase()} OFFSETS\n`;
                                  groupItems.forEach(it => {
                                    text += `${it.name.padEnd(28)} = ${it.offset};\n`;
                                  });
                                  navigator.clipboard.writeText(text);
                                  setOffsetsCopiedId(`grp-${grp}`);
                                  setTimeout(() => setOffsetsCopiedId(null), 1500);
                                }}
                                className="px-3 py-1.5 bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-red-500/30 text-slate-300 hover:text-white font-bold font-display text-[11px] rounded-lg transition-all cursor-pointer flex items-center gap-1.5 uppercase self-start sm:self-auto"
                              >
                                {offsetsCopiedId === `grp-${grp}` ? (
                                  <>
                                    <Check className="w-3.5 h-3.5 text-emerald-400" />
                                    <span className="text-emerald-400">COPIED GROUP!</span>
                                  </>
                                ) : (
                                  <>
                                    <Copy className="w-3.5 h-3.5 text-slate-400" />
                                    <span>COPY {grp.toUpperCase()}</span>
                                  </>
                                )}
                              </button>
                            </div>
                            ...
                            <div className="p-4 sm:p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
                              {groupItems.map((item) => {
                                const isItemCopied = offsetsCopiedId === item.name;

                                return (
                                  <div
                                    key={`${item.group}-${item.name}`}
                                    className="bg-[#07070b] border border-red-950/20 hover:border-red-500/30 rounded-2xl p-3.5 flex flex-col justify-between transition-all duration-200 group relative hover:shadow-[0_0_20px_rgba(239,68,68,0.06)]"
                                  >
                                    <div className="flex items-start justify-between gap-2 mb-2">
                                      <div className="min-w-0 flex-1">
                                        <div className="text-xs font-bold text-white font-display truncate group-hover:text-red-400 transition-colors" title={item.name}>
                                          {item.name}
                                        </div>
                                        <div className="text-[10px] text-slate-500 font-mono truncate mt-0.5" title={item.matchedSearch}>
                                          Search: <span className="text-slate-400">{item.matchedSearch}</span>
                                        </div>
                                      </div>
                                      <span className="text-[9px] font-mono uppercase bg-slate-900/80 border border-slate-800 text-slate-400 px-1.5 py-0.5 rounded font-semibold shrink-0">
                                        {item.group}
                                      </span>
                                    </div>

                                    <div className="flex items-center justify-between gap-2 mt-2 pt-2.5 border-t border-red-950/20">
                                      <div className="bg-[#040407] border border-red-500/20 px-2.5 py-1 rounded-lg">
                                        <span className="text-xs font-mono font-bold text-red-400 tracking-wider select-all">
                                          {item.offset}
                                        </span>
                                      </div>
                                      ...
                                      <button
                                        onClick={() => {
                                          navigator.clipboard.writeText(item.offset);
                                          setOffsetsCopiedId(item.name);
                                          setTimeout(() => setOffsetsCopiedId(null), 1500);
                                        }}
                                        className={`px-2.5 py-1 rounded-lg text-[10px] font-bold font-display uppercase tracking-wider transition-all flex items-center gap-1 cursor-pointer ${
                                          isItemCopied
                  ...
                  <div className="bg-[#0d0d14]/80 backdrop-blur-md border border-red-950/30 rounded-2xl p-5 shadow-xl">
                    <h3 className="text-xs font-bold tracking-widest uppercase text-white font-display border-b border-red-950/20 pb-3 mb-3 flex items-center justify-between">
                      <span>OFFSETS FINDER ENGINE</span>
                      <span className="text-[10px] text-slate-500 font-mono">IL2CPP PARSER V2</span>
                    </h3>
                    <p className="text-slate-400 text-xs leading-relaxed">
                      Only valid, successfully extracted offset addresses are shown above, grouped by functional categories: Structural, Player, Silent Aim, Speed, and Weapon. Click "Copy" on any item to copy its offset hex value, or use "Copy All" to export all discovered offsets formatted for direct C++ or C# header insertion.
                    </p>
                  </div>
                </motion.div>
              )}
